    ...
    */
    ...
    switch (converter['converter']) {
        ...
        case 'cwebp':
            ...
            break;
        case 'imagickbinary':
            document.getElementById('imagickbinary_use_nice').checked = getConverterOption(converter, 'use-nice', true);
            break;
        case 'gmagickbinary':
            document.getElementById('gmagickbinary_use_nice').checked = getConverterOption(converter, 'use-nice', true);
            break;
        case 'vips':
    ...
    */
    ...
    switch (converter['converter']) {
        ...
        case 'imagickbinary':
            ...
            break;
        case 'gmagickbinary':
            setConverterOption(converter, 'use-nice', document.getElementById('gmagickbinary_use_nice').checked);
            break;
        case 'vips':
