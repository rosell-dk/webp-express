    ...
    switch (converter['converter']) {
        ...
        case 'wpc':
            ...
            */
            ...
            apiVersion = getConverterOption(converter, 'api-version', 1);
            ...
            document.getElementById('wpc_crypt_api_key_in_transfer').checked = getConverterOption(converter, 'wpc-crypt-api-key-in-transfer', true);
...
function updateConverterOptions() {
    ...
    switch (converter['converter']) {
        ...
        case 'wpc':
            ...
            if (apiVersion == '1') {
                setConverterOption(converter, 'wpc-crypt-api-key-in-transfer', document.getElementById('wpc_crypt_api_key_in_transfer').checked);
            }
            ...
            if (document.getElementById('wpc_new_api_key').style.display == 'inline') {
                ...
                delete converter['options']['new-api-key'];
