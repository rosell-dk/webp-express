...
function updateCacheControlHeaderVisibility() {
    if (document.getElementById('redirect_to_existing_in_htaccess')) {
        setOptionVisibility('cache_control_div', document.getElementById('redirect_to_existing_in_htaccess').checked);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.getElementById('redirect_to_existing_in_htaccess')) {
        document.getElementById('redirect_to_existing_in_htaccess').addEventListener('change', function() {
            updateCacheControlHeaderVisibility();
        });
    }
