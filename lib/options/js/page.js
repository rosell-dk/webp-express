...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (el('jpeg_encoding_select') && el('jpeg_quality_lossless_row')) {
        function updateJpgEncoding() {
            toggleVisibility('jpeg_quality_lossless_row', el('jpeg_encoding_select').value != 'lossy');
        }
        updateJpgEncoding();
    ...
    if (el('png_encoding_select') && el('png_quality_lossy_row')) {
        function updatePngEncoding() {
            toggleVisibility('png_quality_lossy_row', el('png_encoding_select').value != 'lossless');
        }
        updatePngEncoding();
